            ...
            if (isset($_SESSION['user']['ID_utilisateur'])) {
                ...
                <div class="relative" id="clientContainer">
                    ...
                    <div class="absolute hidden bg-gray-800 p-4 top-10 right-0" id="clientMenu">
                        <a href="../controllers/controller-historique.php"><button class="text-white font-bold block mt-3 hover:underline">
                                Mes commandes
                            </button></a>
                        <a href="../controllers/controller-logout.php"><button class="text-white font-bold block mt-3 hover:underline">
                                Déconnexion
                            </button></a>
                    </div>
                </div>';
